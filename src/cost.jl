...
function sumcosts(tracker1 :: CorrelationTracker{T, N},
                  tracker2 :: CorrelationTracker{T, N},
...
euclid_mean(data1 :: CorrelationTracker{T, N},
            data2 :: CorrelationTracker{T, N}) where {T, N} =
...
function euclid_directional(data1 :: CorrelationTracker{T, N},
                            data2 :: CorrelationTracker{T, N}) where {T, N}
...
"""
function euclid_mean_weighted(data1 :: CorrelationTracker{T, N},
                              data2 :: CorrelationTracker{T, N}) where {T, N}
...
Kirill M. Gerke and Marina V. Karsanina 2015 EPL 111 56002
"""
function euclid_directional_weighted(data1 :: CorrelationTracker{T, N},
                                     data2 :: CorrelationTracker{T, N}) where {T, N}
    @assert tracked_data(data1) == tracked_data(data2)
    # At first, calculate weights for all correlation functions
...
function generalized_čapek_cost(data1 :: CorrelationTracker{T, N},
    ...
    local function f(data1 :: CorrelationTracker, data2 :: CorrelationTracker)
        # S2
